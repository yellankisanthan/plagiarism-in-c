...
#include <math.h>
#include <ctype.h>
#include "fp_operations.h"
void openfile(char *files[5],int x)					// openfile function takes filenames as argument and size of array
{
...
int main(int argc,char *argv[])											//main function for taking the file names in the directory
{
	char *files[50];
	int i=0;
	DIR *d;
